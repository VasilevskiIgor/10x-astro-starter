...
// Use process.env during SSR/build on Vercel, import.meta.env in browser
// @ts-ignore - process may not be defined in browser
const supabaseUrl = (typeof process !== 'undefined' && process.env.PUBLIC_SUPABASE_URL) || import.meta.env.PUBLIC_SUPABASE_URL || "http://127.0.0.1:54321";
// @ts-ignore - process may not be defined in browser
